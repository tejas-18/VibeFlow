...
def init_genai() -> Any:
    """
    Initializes the Google Gemini API with robust safety settings and configurations.
    Returns:
        The configured Gemini model object, or None if the API key is invalid.
    """
    ...
    # Implement strict safety settings for security compliance
    safety_settings = [
    ...
    # Implement generation config for deterministic efficiency
...
with main_left:
    ...
    def get_color(occ: int) -> str:
        """Returns hex color code based on occupancy threshold."""
